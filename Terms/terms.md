...
`POJO` был представлен в качестве альтернативы для `JavaBeans` и других «тяжелых» enterprise-конструкций, которые были популярны в 2000-х годах (об этом можно почитать в [статье](https://dou.ua/lenta/articles/javaee-vs-spring/) Сергея Немчинского)
