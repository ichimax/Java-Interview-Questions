...
### <a name="4">4. Entity
«Сущность» - это данные, которые мы сохраняем в базу в формате базы данных, т.е. данные, приближенные к таблицам DB (типы и названия столбцов таблицы == типам и названиям полей в классе, взаимодействующему с конкретной таблицей). Хранятся в `domain` слое
